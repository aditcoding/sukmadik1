    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="/dosen/p" class="nav-link">
          <img src="../img/Absen.svg
          " alt="Dosen" class="icon"> Presensi
        </a>
      </li>
      <li>
        <a href="/dosen/b" class="nav-link">
          <img src="../img/Bimbingan.svg" alt="Kampus" class="icon"> Bimbingan
        </a>
      </li>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/dosen" class="btn btn-danger">Iya</a>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  document.getElementById('nama-user').textContent = "<?php echo $_SESSION['nama_user'] ?? 'Dosen'; ?>";
</script>
