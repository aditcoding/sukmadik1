...
<div class="d-flex">
  ...
  <div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="/mhs/j" class="nav-link">
          <img src="../img/Jadwal.svg" alt="Beranda" class="icon"> Jadwal Bimbingan
        </a>
      </li>
      <li>
        <a href="/mhs/s" class="nav-link">
          <img src="../img/Sesi.svg" alt="Dosen" class="icon"> Ketersediaan Sesi
        </a>
      </li>
      <li>
        <a href="/mhs/" class="nav-link">
          <img src="../img/Pengajuan.svg" alt="Kampus" class="icon"> Pengajuan Bimbingan
        </a>
      </li>
  ...
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/dashboard" class="btn btn-danger">Iya</a>
      </div>
    </div>
  </div>
</div>
